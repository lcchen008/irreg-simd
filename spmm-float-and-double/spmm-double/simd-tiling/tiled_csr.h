...
class Tile {
 public:
  ...
  void SetVectorZero() {
    *(__m512d*)&values = _mm512_set1_pd(0);
    *((__m512d*)&values + 1) = _mm512_set1_pd(0);
  }
  ...
  void operator+=(const Tile<ValueType>& t) {
    *(__m512d*)&values = _mm512_add_pd(*(__m512d*)&values, *(__m512d*)&t);
    *(__m512d*)(&values[0] + 8) = _mm512_add_pd(*(__m512d*)(&values[0]+8), *(__m512d*)(&t.values[0] + 8));
  }
