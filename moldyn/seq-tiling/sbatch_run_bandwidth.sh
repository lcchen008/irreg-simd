...
amplxe-cl -collect knc-bandwidth -r "../vtune10" -target-duration-type=long ./main ../../input/32-3.0r/32-3.0r.mesh.matlab.reordered ../../input/32-3.0r/32-3.0r.xyz.reordered
